...
//
// @id = ch.banana.africa.financialanalysisrdcmulticurrency
// @api = 1.0
// @pubdate = 2020-08-24
// @publisher = Banana.ch SA
// @description = Financial Analysis Report Multicurrency (OHADA - RDC) [BETA]
// @description.fr = Analyse Financière Multi-devise (OHADA - RDC) [BETA]
// @task = app.command
// @doctype = 100.*
// @docproperties =
// @outputformat = none
...
/*
   ...
   This BananaApp creates a financial analysis multicurrency report for DRC.
...
function exec() {
    ...
    var report = createFinancialAnalysisMulticurrencyReport(current, userParam.selectionStartDate, userParam.selectionEndDate, userParam);
    var stylesheet = createStyleSheet();
    Banana.Report.preview(report, stylesheet);
 }
 
 function createFinancialAnalysisMulticurrencyReport(current, startDate, endDate, userParam, report) {
   ...
   /* FRN */
   var result_FRN = calculate_FRN(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_FRN,userParam.decimals), "center", 3);
 
   /* FRP */
   var result_FRP = calculate_FRP(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_FRP,userParam.decimals), "center", 3);
 
   /* FRE */
   var result_FRE = calculate_FRE(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   tableRow.addCell("FRE", "bold", 2);
   tableRow.addCell("Fonds de Roulement Étranger", "", 6);
   tableRow.addCell("Dettes financières", "", 9);
   tableRow.addCell(formatValues(result_FRE,userParam.decimals), "center", 3);
 
   /* BFRG */
   var result_BFRG = calculate_BFRG(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_BFRG,userParam.decimals), "center", 3);
 
   /* BFRE */
   var result_BFRE = calculate_BFRE(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_BFRE,userParam.decimals), "center", 3);
 
   /* BFHAO */
   var result_BFHAO = calculate_BFHAO(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_BFHAO,userParam.decimals), "center", 3);
 
   /* TN */
   var result_TN = calculate_TN(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   tableRow.addCell("TN", "bold", 2);
   tableRow.addCell("Trésorerie Nette", "", 6);
   tableRow.addCell("(Trésorerie-Actif) - (Trésorerie-Passif)", "", 9);
   tableRow.addCell(formatValues(result_TN,userParam.decimals), "center", 3);
 
   var tableRow = table.addRow();
   tableRow.addCell("Analyse de la structure financière par la méthode des ratios", "bold center", 20);
 
   /* RCAFR */
   var result_RCAFR = calculate_RCAFR(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RCAFR,userParam.decimals), "center", 3);
 
   /* RCAFC */
   var result_RCAFC = calculate_RCAFC(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RCAFC,userParam.decimals), "center", 3);
 
   /* RBFRG */
   var result_RBFRG = calculate_RBFRG(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RBFRG,userParam.decimals), "center", 3);
 
   /* RS */
   var result_RS = calculate_RS(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   tableRow.addCell("RS", "bold", 2);
   tableRow.addCell("Ratio de solvabilité","", 6);
   tableRow.addCell("(Passif Total)/(Dettes Totales)","", 9);
   tableRow.addCell(formatValues(result_RS,userParam.decimals), "center", 3);
 
   /* RIF */
   var result_RIF = calculate_RIF(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RIF,userParam.decimals), "center", 3);
 
   /* RDF */
   var result_RDF = calculate_RDF(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   tableRow.addCell("RDF", "bold", 2);
   tableRow.addCell("Ratio de dépendance financière","", 6);
   tableRow.addCell("(Capitaux Propres)/(Actifs Immobilisés)","", 9);
   tableRow.addCell(formatValues(result_RDF,userParam.decimals), "center", 3);
 
   /* RLG */
   var result_RLG = calculate_RLG(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RLG,userParam.decimals), "center", 3);
 
   /* RLR */
   var result_RLR = calculate_RLR(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RLR,userParam.decimals), "center", 3);
 
   /* RLI */
   var result_RLI = calculate_RLI(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RLI,userParam.decimals), "center", 3);
   ...
   /* RA */
   var result_RA = calculate_RA(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RA,userParam.decimals), "center", 3);
 
   /* TM */
   var result_TM = calculate_TM(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_TM,userParam.decimals), "center", 3);
 
   /* ROI */
   var result_ROI = calculate_ROI(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_ROI,userParam.decimals), "center", 3);
 
   /* RCP */
   var result_RCP = calculate_RCP(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RCP,userParam.decimals), "center", 3);
 
   /* RCS */
   var result_RCS = calculate_RCS(current, currentStartDate, currentEndDate, userParam);
   var tableRow = table.addRow();
   ...
   tableRow.addCell(formatValues(result_RCS,userParam.decimals), "center", 3);
 
   return report;
 }
 
 /* Calculate FRN */
 function calculate_FRN(banDoc, startDate, endDate, userParam) {
    /*
       {
    ...
    */
    var grDF = getAmount(banDoc, 'Gr=DF', 'balance', startDate, endDate, userParam);
    var gr47841 = getAmount(banDoc, 'Gr=47841', 'balance', startDate, endDate, userParam);
    var gr47842 = getAmount(banDoc, 'Gr=47842', 'balance', startDate, endDate, userParam);
    var gr47941 = getAmount(banDoc, 'Gr=47941', 'balance', startDate, endDate, userParam);
    var gr47942 = getAmount(banDoc, 'Gr=47942', 'balance', startDate, endDate, userParam);
    var grAZ = getAmount(banDoc, 'Gr=AZ', 'balance', startDate, endDate, userParam);
    var gr4782 = getAmount(banDoc, 'Gr=4782', 'balance', startDate, endDate, userParam);
    var gr4792 = getAmount(banDoc, 'Gr=4792', 'balance', startDate, endDate, userParam);
    var res_a = 0;
 ...
 /* Calculate FRP */
 function calculate_FRP(banDoc, startDate, endDate, userParam) {
    /*
       {
    ...
    */
    var grCP = getAmount(banDoc, 'Gr=CP', 'balance', startDate, endDate, userParam);
    var grAZ = getAmount(banDoc, 'Gr=AZ', 'balance', startDate, endDate, userParam);
    var gr4782 = getAmount(banDoc, 'Gr=4782', 'balance', startDate, endDate, userParam);
    var gr4792 = getAmount(banDoc, 'Gr=4792', 'balance', startDate, endDate, userParam);
    var res_a = 0;
 ...
 /* Calculate FRE */
 function calculate_FRE(banDoc, startDate, endDate, userParam) {
    /*
       ...
       + (-1)getAmount(Gr=47942,balance)
    */
    var grDD = getAmount(banDoc, 'Gr=DD', 'balance', startDate, endDate, userParam);
    var gr47841 = getAmount(banDoc, 'Gr=47841', 'balance', startDate, endDate, userParam);
    var gr47842 = getAmount(banDoc, 'Gr=47842', 'balance', startDate, endDate, userParam);
    var gr47941 = getAmount(banDoc, 'Gr=47941', 'balance', startDate, endDate, userParam);
    var gr47942 = getAmount(banDoc, 'Gr=47942', 'balance', startDate, endDate, userParam);
 ...
 /* Calculate BFRG */
 function calculate_BFRG(banDoc, startDate, endDate, userParam) {
    /*
       {
    ...
    */
    var grBK = getAmount(banDoc, 'Gr=BK', 'balance', startDate, endDate, userParam);
    var gr4781 = getAmount(banDoc, 'Gr=4781', 'balance', startDate, endDate, userParam);
    var gr4783 = getAmount(banDoc, 'Gr=4783', 'balance', startDate, endDate, userParam);
    var grDP = getAmount(banDoc, 'Gr=DP', 'balance', startDate, endDate, userParam);
    var gr4791 = getAmount(banDoc, 'Gr=4791', 'balance', startDate, endDate, userParam);
    var gr4793 = getAmount(banDoc, 'Gr=4793', 'balance', startDate, endDate, userParam);
    var res_a = 0;
 ...
 /* Calculate BFRE */
 function calculate_BFRE(banDoc, startDate, endDate, userParam) {
    /*
       {
          + getAmount(Gr=BK, balance)
          + getAmount(Gr=4781, balance)
    ...
    */
    ...
    var gr4781 = getAmount(banDoc, 'Gr=4781', 'balance', startDate, endDate, userParam);
    var gr4783 = getAmount(banDoc, 'Gr=4783', 'balance', startDate, endDate, userParam);
    var grBA = getAmount(banDoc, 'Gr=BA', 'balance', startDate, endDate, userParam);
    var grDP = getAmount(banDoc, 'Gr=DP', 'balance', startDate, endDate, userParam);
    var gr4791 = getAmount(banDoc, 'Gr=4791', 'balance', startDate, endDate, userParam);
    var gr4793 = getAmount(banDoc, 'Gr=4793', 'balance', startDate, endDate, userParam);
    var grDH = getAmount(banDoc, 'Gr=DH', 'balance', startDate, endDate, userParam);
    var res_a = 0;
    res_a = Banana.SDecimal.add(res_a, grBK);
    res_a = Banana.SDecimal.add(res_a, gr4781);
    res_a = Banana.SDecimal.add(res_a, gr4783);
 ...
 /* Calculate BFHAO */
 function calculate_BFHAO(banDoc, startDate, endDate, userParam) {
    /*
       + getAmount(Gr=BA, balance)
       - (-1)getAmount(Gr=DH, balance)
    */
 ...
 /* Calculate TN */
 function calculate_TN(banDoc, startDate, endDate, userParam) {
    /*
       + getAmount(Gr=BT, balance)
       - (-1)getAmount(Gr=DT, balance)
    */
    var grBT = getAmount(banDoc, 'Gr=BT', 'balance', startDate, endDate, userParam);
    var grDT = getAmount(banDoc, 'Gr=DT', 'balance', startDate, endDate, userParam);
    var res = 0;
 ...
 /* Calculate RCAFR */
 function calculate_RCAFR(banDoc, startDate, endDate, userParam) {
    /*
       {
          + (-1)getAmount(Gr=DF, balance)
          + getAmount(Gr=47841, balance)
 ...
 /* Calculate RCAFC */
 function calculate_RCAFC(banDoc, startDate, endDate, userParam) {
    /*
       {
          + (-1)getAmount(Gr=CP, balance)
       }
 ...
 /* Calculate RBFRG */
 function calculate_RBFRG(banDoc, startDate, endDate, userParam) {
    /*
       {
          + (-1)getAmount(Gr=DF, balance)
          - getAmount(Gr=AZ, balance)
 ...
 /* Calculate RS */
 function calculate_RS(banDoc, startDate, endDate, userParam) {
    /*
       {
    ...
    */
    var grDZ = getAmount(banDoc, 'Gr=DZ', 'balance', startDate, endDate, userParam);
    var grDP = getAmount(banDoc, 'Gr=DP', 'balance', startDate, endDate, userParam);
    var gr4791 = getAmount(banDoc, 'Gr=4791', 'balance', startDate, endDate, userParam);
    var gr4793 = getAmount(banDoc, 'Gr=4793', 'balance', startDate, endDate, userParam);
    var grDD = getAmount(banDoc, 'Gr=DD', 'balance', startDate, endDate, userParam);
 ...
 /* Calculate RIF */
 function calculate_RIF(banDoc, startDate, endDate, userParam) {
    /*
       {
          + (-1)getAmount(Gr=CP, balance)
       }
 ...
 /* Calculate RDF */
 function calculate_RDF(banDoc, startDate, endDate, userParam) {
    /*
       {
          + (-1)getAmount(Gr=DP, balance)
          + (-1)getAmount(Gr=4791, balance)
 ...
 /* Calculate RLG */
 function calculate_RLG(banDoc, startDate, endDate, userParam) {
    /*
       {
          + getAmount(Gr=BK, balance)
          + getAmount(Gr=4781, balance)
 ...
 /* Calculate RLR */
 function calculate_RLR(banDoc, startDate, endDate, userParam) {
    /*
       {
       ...
       D = Denominator
    */
    var grBA = getAmount(banDoc, 'Gr=BA', 'total', startDate, endDate, userParam);
    ...
    var grBT = getAmount(banDoc, 'Gr=BT', 'total', startDate, endDate, userParam);
    var grDP = getAmount(banDoc, 'Gr=DP', 'balance', startDate, endDate, userParam);
    var gr4791 = getAmount(banDoc, 'Gr=4791', 'balance', startDate, endDate, userParam);
    var gr4793 = getAmount(banDoc, 'Gr=4793', 'balance', startDate, endDate, userParam);
    var grDT = getAmount(banDoc, 'Gr=DT', 'balance', startDate, endDate, userParam);
 ...
 /* Calculate RLI */
 function calculate_RLI(banDoc, startDate, endDate, userParam) {
    /*
       {
          + getAmount(Gr=BT, balance)
       }
 ...
 /* Calculate RA */
 function calculate_RA(banDoc, startDate, endDate, userParam) {
    /*
       {
    ...
    */
    var gr135 = getAmount(banDoc, 'Gr=135', 'total', startDate, endDate, userParam);
    var grTA = getAmount(banDoc, 'Gr=TA', 'total', startDate, endDate, userParam);
    var grTB = getAmount(banDoc, 'Gr=TB', 'total', startDate, endDate, userParam);
    var grTC = getAmount(banDoc, 'Gr=TC', 'total', startDate, endDate, userParam);
    var grTD = getAmount(banDoc, 'Gr=TD', 'total', startDate, endDate, userParam);
    var res_N = 0;
 ...
 /* Calculate TM */
 function calculate_TM(banDoc, startDate, endDate, userParam) {
    /*
       { + (-1)getAmount(Gr=132, total) }
       :
       { + (-1)getAmount(Gr=TA, total) }
    */
    var gr132 = getAmount(banDoc, 'Gr=132', 'total', startDate, endDate, userParam);
    var grTA = getAmount(banDoc, 'Gr=TA', 'total', startDate, endDate, userParam);
    var res_N = 0;
    var res_D = 0;
 ...
 /* Calculate ROI */
 function calculate_ROI(banDoc, startDate, endDate, userParam) {
    /*
       { + (-1)getAmount(Gr=135, total) }
       :
    ...
    */
    var gr135 = getAmount(banDoc, 'Gr=135', 'total', startDate, endDate, userParam);
    var grBZ = getAmount(banDoc, 'Gr=BZ', 'balance', startDate, endDate, userParam);
    var res_N = 0;
    var res_D = 0;
    res_N = Banana.SDecimal.add(res_N, Banana.SDecimal.invert(gr135));
    res_N = Banana.SDecimal.multiply(res_N, '100');
 ...
 /* Calculate RCP */
 function calculate_RCP(banDoc, startDate, endDate, userParam) {
    /*
       { + (-1)getAmount(Gr=131, total) }
       :
       { + (-1)getAmount(Gr=CP, total) }
    */
    var gr131 = getAmount(banDoc, 'Gr=131', 'total', startDate, endDate, userParam);
    var grCP = getAmount(banDoc, 'Gr=CP', 'balance', startDate, endDate, userParam);
    var res_N = 0;
    var res_D = 0;
 ...
 /* Calculate RCS */
 function calculate_RCS(banDoc, startDate, endDate, userParam) {
    /*
       { + (-1)getAmount(Gr=131, total) }
       :
    ...
    */
    var gr131 = getAmount(banDoc, 'Gr=131', 'total', startDate, endDate, userParam);
    var grCA = getAmount(banDoc, 'Gr=CA', 'balance', startDate, endDate, userParam);
    var res_N = 0;
    var res_D = 0;
    res_N = Banana.SDecimal.add(res_N, Banana.SDecimal.invert(gr131));
    res_N = Banana.SDecimal.multiply(res_N, '100');
...
function convertParam(userParam) {
    ...
    currentParam.defaultvalue = 'Analyse financière multi-devise';
