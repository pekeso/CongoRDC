...
// @id = ch.banana.africa.asblbalancesheet.test
// @api = 1.0
// @pubdate = 2023-12-21
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.africa.asblbalancesheet.test.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.africa.asblbalancesheet.js
// @timeout = -1



// Register test case to be executed
Test.registerTestCase(new AsblBalanceSheetReport());

// Here we define the class, the name of the class is not important
function AsblBalanceSheetReport() {

}

// This method will be called at the beginning of the test case
AsblBalanceSheetReport.prototype.initTestCase = function() {

}

// This method will be called at the end of the test case
AsblBalanceSheetReport.prototype.cleanupTestCase = function() {

}

// This method will be called before every test method is executed
AsblBalanceSheetReport.prototype.init = function() {

}

// This method will be called after every test method is executed
AsblBalanceSheetReport.prototype.cleanup = function() {

}

AsblBalanceSheetReport.prototype.testBananaExtension = function() {
